...
std::unique_ptr<SheetInterface> CreateSheetWithCells(int n = 50, int offset = 0) {
    auto sheet = CreateSheet();
...
int main() {
    ...
    {
        auto sheet = CreateSheetWithCells(100);
        sheet->SetCell("XFD16384"_pos, "CELL");
    }
    {
        auto sheet = CreateSheetWithCells(100, 100);
        sheet->SetCell("XFD16384"_pos, "CELL");
    }
